...
class IndexController extends Controller
{
  ...
  public function index()
  {
    ...
    if(parse_url(request()->headers->get('referer'), PHP_URL_PATH) == '/')
      $print = "<div id=\"loader-wrapper\"><div id=\"loader\"></div><div class=\"loader-section section-left\"></div><div class=\"loader-section section-right\"></div><div class=\"loader-trilce\">
