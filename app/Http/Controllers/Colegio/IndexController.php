...
class IndexController extends Controller
{
  ...
  public function index()
  {
    ...
    if(parse_url(request()->headers->get('referer'), PHP_URL_PATH) == '/')
      $print = "<div id=\"loader-wrapper\"><div id=\"loader\" class=\"loadercolegio\"></div><div class=\"loader-section colegio section-left\"></div><div class=\"loader-section colegio section-right\"></div></div>";
    else
    $print = '';
