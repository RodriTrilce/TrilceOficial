...
class ColegioVenueAddressTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      Av. Cuba 414-438','phone' => '619-8118','logitude' => '-12.074882','latitude' => '-77.039687','created_at' => NULL,'updated_at' => NULL),
        ...
        array('id' => '5','idvenue' => '3','grades' => 'Primaria y Secundaria','address' => 'Av. Santa Rosa 1655 Urb. Inca Manco Capac II etapa','phone' => '458-7974 / 458-6462','logitude' => '-12.003895','latitude' => '-76.998862','created_at' => NULL,'updated_at' => NULL),
