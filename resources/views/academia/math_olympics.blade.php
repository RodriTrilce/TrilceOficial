  ...
  <div class="row center-xs center-sm math-olympic-onam">
    ...
    <div class="row col-xs-12 col-sm-9 text-init sponsor">
      ...
      <div class="row col-xs-12 col-sm-6">
        ...
        <div class="col-sm col-xs-4"><img src="{{{ asset('images/academia/logo-arsam.png') }}}" alt="Arsam"></div>
        <div class="col-sm col-xs-4"><img src="{{{ asset('images/academia/logo-maped.png') }}}" alt="Maped"></div>
