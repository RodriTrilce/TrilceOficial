        ...
        <div class="js-tabs__content">
          ...
          <div class="row col-xs-12 ep-large-container">
            <div class="col-xs-12 col-sm-5 ep-stepfour-left center-xs xs-hide">
              <img src="{{ url('/static/images/colegio/propuesta-feb/6-innovacion-1.png') }}" alt="Innovación tecnológica">
            </div>
          ...
          <div class="row col-xs-12 ep-large-container">
            ...
            <div class="col-xs-12 center-xs col-sm ep-stepfour-right ep-stepfour-container xs-hide">
              <img src="{{ url('/static/images/colegio/propuesta-feb/6-innovacion-2.png') }}" alt="Innovación tecnológica">
            </div>
