...
@section('content')
  ...
  <div class="row col-xs-12 center-xs container-base frequentquestions">
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Por qué Trilce no cuenta con talleres de danzas, deportes, etc. que otros colegios sí tienen?</h3>
              <p class="question-answer">La información no es correcta, en Trilce contamos con un taller de teatro y otras actividades como las ferias regionales, concursos de declamación, debate, ajedrez, entre otros, porque consideramos que son importantes para la formación de nuestros estudiantes.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">Mi hijo(a) no es bueno(a) en matemáticas. ¿Se adaptará al sistema de Trilce?</h3>
              <p class="question-answer">Sí, en Trilce contribuimos al desarrollo de las habilidades de los alumnos en diferentes áreas, y logramos que destaquen según sus capacidades. Con respecto a los cursos de matemáticas nosotros contamos con un servicio de asesorías especializadas en los cursos de mayor dificultad, de esta manera los reforzamos para que minimicen sus falencias. Asimismo, a través del Departamento Psicopedagógico brindamos al padre de familia las pautas que estimulen y motiven a su hijo a adaptarse al sistema.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">¿Sobre las asesorías?</h3>
              <p class="question-answer">Las asesorías son gratuitas y se dictan para los alumnos de primaria y secundaria. Son un beneficio que le permite al alumno aclarar sus dudas sobre los temas desarrollados en clase a través de una explicación detallada. Estas se dan fuera del horario regular.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">Traslados internos</h3>
              <p class="question-answer">Si el padre de familia desea trasladar a su hijo a otra sede de Trilce, tendrá que realizar el siguiente trámite:<br><br>
...
<ul>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">Trámite para solicitar constancia de Tercio Superior</h3>
              <p class="question-answer">Este dato figura en la parte inferior de la libreta de notas. Si el padre de familia desea solicitar una constancia de Tercio Superior, deberá acercarse al área de atención al cliente presentando una solicitud simple. Ver costo en el cuadro de trámites documentarios.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">Solicitudes de descuentos por hermanos</h3>
              <p class="question-answer">El padre de familia puede presentar su solicitud de descuento, en la cual tendrá que exponer y sustentar los motivos por los que lo solicita. Se otorgará la beca al mayor de los hermanos. La solicitud se envía hasta el 15 de enero.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">Código modular del colegio</h3>
              <p class="question-answer">Consultar con la sede Trilce indicada (para que se coordine con el área de Actas).</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">Sobre la entrega de libros, material de estudio y cursos</h3>
    ...
    *Religión: Se dicta el curso de religión a los alumnos de inicial (prekínder y kínder) y primaria.<br><br>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Se entregan exámenes bimestrales?</h3>
              <p class="question-answer">Los exámenes bimestrales son materiales clasificados que requieren de mucha privacidad. Sin embargo, si desea tener acceso a los exámenes bimestrales, solo tiene que solicitarlo en Coordinación y lo podrá revisar en presencia del tutor.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">Corte de Cabello</h3>
              <p class="question-answer">Hay límites razonables por higiene y por presentación; así también lo indica el Manual de Convivencia (Reglamento Interno), aprobado por el Ministerio de Educación.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Hay una frecuente comunicación entre padres y docentes?</h3>
              <p class="question-answer">Si el padre de familia desea conversar con los docentes, debe solicitar una entrevista anticipadamente.</p>
            </div>
          </div>
...
Si el alumno tiene actividades fuera del horario, contará con un descanso de 45 minutos a una hora.
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Las pensiones son elevadas?</h3>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">En Trilce existen exámenes semanales y diarios, ¿no son muchas evaluaciones para sus estudiantes?</h3>
              <p class="question-answer">Es importante que los alumnos se adecúen a las exigencias académicas y es necesario que adquieran el hábito de estudio. Esto les dará buenos resultados en su preparación académica.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">Sobre las reagrupaciones (clasificación en aulas según el rendimiento académico de los alumnos)</h3>
              <p class="question-answer">Buscamos competitividad entre nuestros alumnos y que se esfuercen, bimestre a bimestre, para mejorar su nivel académico. En Trilce todos los docentes son de excelente nivel y la disciplina es fundamental, independientemente de la sección en que se encuentren.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">Sobre los uniformes</h3>
              <p class="question-answer">Nuestros alumnos no utilizan uniforme escolar, dado que no deseamos generar más gastos al padre de familia. Además, es importante que el alumno se sienta más cómodo para estudiar. El Ministerio de Educación tiene una disposición en la que se indica que el uso de uniforme no es obligatorio. Sin embargo, el alumno recibe las Normas de Convivencia (Reglamento Interno), en las cuales se hacen precisiones sobre la vestimenta que el alumno puede utilizar.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">Calidad de la enseñanza de nuestros docentes</h3>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">Retiros por bajo rendimiento</h3>
              <p class="question-answer">Todo alumno que se incorpora a la institución tiene un periodo de adaptación; le planteamos el sistema de asesorías y lo derivamos al Departamento Psicopedagógico. Los alumnos nuevos deben esforzarse más y tener paciencia para adecuarse al sistema. Además de lo indicado, los profesores los ayudan para que puedan nivelarse en el menor tiempo posible.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Qué ocurre si a mi hijo le cuesta adaptarse?</h3>
              <p class="question-answer">Si el alumno tiene problemas para adaptarse al colegio, cuentan con el apoyo del Departamento de Psicología y, en forma constante, con el de su tutora.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">No estoy de acuerdo con las clasificaciones que realizan con los alumnos (niveles avanzados, intermedios y básicos)</h3>
              <p class="question-answer">El propósito no es limitar al alumno, solo se desea que aprendan a su propio ritmo e incentivar su esfuerzo para mejorar su nivel. Todos los niveles cuentan con la misma calidad de enseñanza.</p>
            </div>
          </div>
    ...
    {{-- <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Se aceptan repitentes?</h3>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Qué grado de credibilidad tienen sus servicios?</h3>
              <p class="question-answer">Trilce cuenta con una excelente plana docente y sistema académico; por otro lado, nuestros resultados hablan por sí solos: primeros puestos en universidades prestigiosas como UNI, San Marcos y PUCP, y, sobre todo, miles de ingresantes (que después se convierten en excelentes universitarios) en diversas universidades del país.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Cómo me garantizan que mi hijo ingresará a la universidad?</h3>
              <p class="question-answer">Eso no se puede garantizar. Lo que sí le garantizamos es que le brindaremos a su hijo una excelente preparación académica, pues contamos con un alto nivel en matemática, ciencias y letras, además de una sólida formación en valores.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Qué pasa si mi hijo no entiende algunos cursos?</h3>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Cuántas horas de clases enseñan arte?</h3>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Cuál es el sistema académico en Trilce?</h3>
              <p class="question-answer">En un sistema desarrollado por una plana docente de la especialidad según el curso que dictan.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">¿Se aceptan niños especiales en el colegio?</h3>
              <p class="question-answer">Sí aceptamos a niños especiales, ya que somos un colegio inclusivo. El alumno deberá rendir las evaluaciones de admisión para saber el nivel académico en el que se encuentra.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Qué edad deben tener los alumnos que se matriculen en secundaria?</h3>
              <p class="question-answer">El tercer y último nivel dura cinco años. Según las disposiciones del Ministerio de Educación, los alumnos de secundaria deben ser jóvenes de entre 11 (o 12) a 16 (o 17) años de edad.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">¿Los postulantes reciben algún temario de cursos antes de rendir evaluaciones?</h3>
              <p class="question-answer">No se entrega ningún tipo de temario antes de las evaluaciones, ya que los postulantes son evaluados de acuerdo a su edad y nivel académico.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Si un exalumno desea regresar al colegio, tendrá que ser evaluado nuevamente?</h3>
    ...
    <div class="frequentquestions-question row col-xs-12">
      ...
      <div class="col-xs question-content">
        <h3 class="question-title">¿Un postulante, luego de no haber sido admitido, puede volver a postular?</h3>
              <p class="question-answer">Sí podrá hacerlo, pero deberá haber transcurrido un año desde dicho proceso de admisión.</p>
            </div>
          </div>
    ...
    <div class="frequentquestions-question row col-xs-12">
      <div class="row col-xs-1 question-number"></div>
      <div class="col-xs question-content">
        <h3 class="question-title">¿Qué cursos son evaluados en secundaria?</h3>
              <p class="question-answer">Matemática, comunicación e inglés (básico). Los exámenes cuentan con 50 preguntas aproximadamente.</p>
            </div>
          </div>
