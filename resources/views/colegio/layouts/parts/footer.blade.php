<footer>
  <div class="row col-xs-12 center-xs">
    ...
    <div class="row col-xs-11 center-xs footer-menu">
      ...
      <div class="col-xs end-xs">
          ...
          <ul class="footer-right-icons">
            ...
            <li><a href="https://www.facebook.com/ColegioTrilce/?pnref=lhc" title="Siguenos Facebook" target="_blank" rel="nofollow"><i class="fa fa-facebook-f"></i></a></li>
    ...
    <div class="col-xs-12 center-xs footer-bottom">
      © {{date("Y")}} Trilce Colegio todos los derechos reservados.
    </div>
  </div>
</footer>
