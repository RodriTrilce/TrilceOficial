    ...
    <div class="row between-xs header-web">
      ...
      <div class="row col-xs col-sm-9 col-lg-10 end-xs">
          <div class="col-xs-12 nav-info">
              <span class="nav-info-content nav-info-colegio"><a href="/"><i class="fa fa-home"></i></a> | <a href="http://intranet.trilce.edu.pe" target="_blank">Intranet para alumnos</a> | Call center: <a class="nav-info-colegio__phone" href="tel:016198100"><b>619-8100</b></a>  <span>|</span> <a href="/menu-trilce" target="_blank">Menú Trilce</a> </span>
          </div>
          <div class="col-xs-12">
            <nav class="nav-burger">
              ...
              <ul>
                ...
                <li><a href="/colegio/vacaciones-utiles" class="{{ (Request::is('*vacaciones-utiles*')?'nav-item-active':'') }} ">Vacaciones Útiles 2019</a></li>
