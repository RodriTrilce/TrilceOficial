          ...
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              ...
              <ul class="ep-generic-list">
                <li>
                  <span class="orange">· Al contado: S/230</span><br>
                  <span class="orange">· 2 partes: S/250</span><br>
                  · S/150 (al matricularse)<br>
                  · S/100 (26 de enero)
                </li>
              </ul>
            </li>
    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <h3><strong>DANZA</strong></h3>
              <p>
                Martes y jueves de 9:30 a. m. a 11 a. m.
              </p>
            </li>
            <br>

            <li>
              <h3><strong>FULBITO</strong></h3>
              <p>
                Martes y jueves de 11 a. m. a 12:30 a. m.
              </p>
            </li>
            <br>
              ...
              <li>
                ...
                <span>Por cada taller <br> (pago por ciclo completo)</span>
              </li>
        ...
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              ...
              <ul class="ep-generic-list">
                <li>
                  <span class="orange">1.<sup>er</sup> a 3.<sup>er</sup> año</span>
        ...
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              ...
              <p>
                Martes y jueves de 8 a. m. a 9:30 a. m.
              </p>
            </li>
            <br>
            ...
            <li>
              <strong><span class="orange">INVERSIÓN: S/100</span></strong> <br>
              <span>(pago por ciclo completo) <br> No incluye materiales</span>
            </li>
      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <h3><spam class="orange">SECUNDARIA</spam></h3>
