      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 6.<sup>o</sup> grado</h2>
      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 2.<sup>o</sup> y 3.<sup>er</sup> año</h2>
            ...
            <li>
              ...
              <p>Lunes, miércoles, jueves y viernes de 10 a. m. a 2 p. m.</p>
            </li>
            ...
            <li>
              ...
              <ul class="ep-generic-list">
                <li>
                  <span class="orange">1.<sup>er</sup> a 3.<sup>er</sup> año</span><br>
                  <span class="orange">· Al contado: S/250</span><br>
                  <span class="orange">· 2 partes: S/270</span><br>
                  · S/200 (al matricularse)<br>
                  · S/70 (30 de enero)
                ...
                <li>
                  <span class="orange">4.<sup>o</sup> y 5.<sup>o</sup> año</span><br>
                  <span class="orange">· Al contado: S/230</span><br>
                  <span class="orange">· 2 partes: S/320</span><br>
                  · S/230 (al matricularse)<br>
                  · S/90 (30 de enero)
                </li>
