    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> SISTEMA 5.<sup>o</sup> AÑO SAN MARCOS</h2>
              <p><strong>Aritmética, Álgebra, Geometría, Física, Química y Biología</strong></p>
      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li><span class="icon_local_span"><i class="fa fa-stop"></i></span> <strong>5.<sup>o</sup> grado:</sup></strong> lunes de 12 m. a 2 p. m.</li>
            <li><span class="icon_local_span"><i class="fa fa-stop"></i></span> <strong>6.<sup>o</sup> grado:</sup></strong> miércoles de 12 m. a 2 p. m.</li>
            <li>
              <strong><span class="orange">INVERSIÓN: S/110</span></strong> <br>
