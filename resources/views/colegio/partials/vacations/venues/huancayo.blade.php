      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 3.<sup>o</sup> año</h2>
            ...
            <li>
              ...
              <ul class="ep-generic-list">
                <li>
                  ...
                  <span class="orange">· Al contado: S/240</span><br>
                  <span class="orange">· 2 partes: S/260</span><br>
                  · S/180 (al matricularse)<br>
                  · S/80 (30 de enero)
                </li>

                <li>
                  <span class="orange">4.<sup>o</sup> y 5.<sup>o</sup> año</span>
      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <strong>Historia Universal</strong>
            </li>
            ...
            <li>
              ...
              <br><br>
              <p>Tres horas semanales</p>
              <p>(consultar frecuencia de horarios)</p>
            </li>

            <li>
              <strong><span class="orange">INVERSIÓN: S/100</span></strong> <br>
              <span>Por cada curso <br> (pago por ciclo completo) <br> No incluye materiales</span>
            </li>
      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <h3><spam class="orange">1.<sup>er</sup> y 2.<sup>o</sup> año</spam></h3>
              <p>Martes y jueves de 8 a. m. a 11 a. m.</p>
            </li>

            <li>
              <h3><spam class="orange">3.<sup>er</sup> año</h3>
              <p>Martes y jueves de 11 a. m. a 2 p. m.</p>
            </li>

            <li><br>
              <strong><span class="orange">INVERSIÓN: S/180</span></strong> <br>
              <span>(pago por ciclo completo)<br>Incluye material didáctico</span>
            </li>
    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <strong>Taller de herramientas de Internet: correo, blog, etc.</strong>
              <p>
                Martes y jueves de 8:15 a. m. a 10 a. m.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                Martes y jueves de 12:15 p. m. a 2 p. m.
              </p>
            </li>

            <li>
              <strong>Diseño Gráfico: Adobe Photoshop e Illustrator</strong>
              <p>
                Martes y jueves de 10:15 a. m. a 12 m.
              </p>
            </li>

            <li><br>
              <strong><span class="orange">INVERSIÓN: S/150</span></strong> <br>
              <span class="orange">Pago por cada taller <br>(pago por ciclo completo) <br> Incluye material didáctico</span>
              <br><br>
            </li>
