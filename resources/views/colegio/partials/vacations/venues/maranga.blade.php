            ...
            <li>
              ...
              <ul class="ep-generic-list">
                <li>
                  ...
                  <span class="orange">· Al contado: S/280</span><br>
                  <span class="orange">· 2 partes: S/300</span><br>
                  · S/200 (al matricularse)<br>
                  · S/100 (30 de enero)
                </li>
        ...
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              ...
              <strong>Aritmética, Álgebra, Geometría, Química, Física y Biología</strong>
              <p>De lunes a viernes de 8 a. m. a 12 m.</p><br>
            </li>
            ...
            <li>
              <strong><span class="orange">INVERSIÓN</span></strong> <br>
              <span class="orange">(pago por ciclo completo) <br> Incluye material didáctico de la academia (libros)</span>
              <br><br>
              <span class="orange">
                <strong>
                <i class="fa fa-stop"></i> Al contado: S/340 <br>
                <i class="fa fa-stop"></i> 2 partes: S/360 <br>
                </strong>
              </span>
              S/260 (al matricularse) <br>
              S/100 (30 de enero)
