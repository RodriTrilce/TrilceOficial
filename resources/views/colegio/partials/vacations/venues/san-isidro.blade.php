        ...
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
                ...
                <p><strong>Aritmética, Álgebra, Geometría, Raz. Matemático, Raz. Verbal, Física y Química</strong></p>
                <p>Lunes, miércoles y viernes de 7:50 a. m. a 1:10 p. m.</p>
            </li>
            ...
            <li>
              ...
              <ul class="ep-generic-list">
                <li>
                  ...
                  <span class="orange">· Al contado: S/480</span><br>
                  <span class="orange">· 2 partes: S/500</span><br>
                ...
                <li>
                  ...
                  <span class="orange">· Al contado: S/560</span><br>
                  <span class="orange">· 2 partes: S/580</span><br>
      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <h3><span class="icon_local_span"><i class="fa fa-stop"></i></span> Nivel I (1.<sup>er</sup> año)</h3>
              <p>Martes y jueves de 8 a. m. a 9:30 a. m.</p>
            </li>

            <li>
              <h3><span class="icon_local_span"><i class="fa fa-stop"></i></span> Nivel II (2.<sup>o</sup> año)</h3>
                <p>Martes y jueves de 9:45 a. m. a 11:15 a. m.</p>
                <br>
            </li>

            <li>
              <h3><span class="icon_local_span"><i class="fa fa-stop"></i></span> Nivel III (3.<sup>er</sup> año)</h3>
    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <strong><span class="orange">PRENSA</span></strong> <br>
              <p>Martes y jueves de 9 a. m. a 11 a. m.</p><br>
              <span class="orange">
                <strong>INVERSIÓN: S/120</strong><br>
                (pago por ciclo completo)
              </span>
              <br><br>
            ...
            <li>
              <strong><span class="orange">DANZA MODERNA</span></strong> <br>
              <p>Martes y jueves de 9 a. m. a 11 a. m.</p><br>
              <span class="orange">
                <strong>INVERSIÓN: S/160</strong><br>
                (pago por ciclo completo)
              </span>
              <br><br>
      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <strong>De martes a viernes de 7:50 a. m. a 1:10 p. m.</strong>
            </li>
