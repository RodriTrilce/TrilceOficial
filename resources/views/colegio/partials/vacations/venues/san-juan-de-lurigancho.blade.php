    ...
    <ul class="js-tabs__header">
      ...
      <li>
            <a href="#" class="js-tabs__title">
              ...
              <div><span class="vacations-svg__title">Talleres Secundaria</span></div>
            </a>
      </li>
    </ul>
        ...
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              ...
              <p><strong>Talleres: Piensa Verde, Clown, Teatro y Psicomotricidad</strong></p>
    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <h3><strong>PIENSA VERDE</strong></h3>
              <p>
                En este curso nos enfocamos en
                  la relación del alumno con el
                  medio ambiente, por lo que
                  trabajamos conceptos que
                  refuerzan dicho vínculo:
                  biodiversidad, jardinería, cultivo,
                  ciclo de los alimentos, entre otros.
              </p>
            </li>
            <br>

            <li>
              <h3><strong>ROBOTIC SPACE</strong></h3>
              <p>
                Trabajamos con nuestros
                alumnos el armado de robots
                en un entorno lúdico. Buscamos
                hacer funcionar sus creaciones
        ...
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              ...
              <p><strong>Aritmética, Álgebra, Raz. Matemático y Ortografía</strong></p>
              <p>Martes, miércoles y viernes de 8 a. m. a 1 p. m.</p>
              <p><strong>Talleres: Piensa Verde, Historietas y English 101</strong></p>
              <p>Jueves de 8 a. m. a 12 m.</p>
            </li>

            <li>
              <strong><span class="orange">INVERSIÓN: S/350</span></strong> <br>
              <span>(pago por ciclo completo) <br> Incluye material didáctico</span>
            </li>
            ...
            <li>
              ...
              <p><strong>Aritmética, Álgebra, Raz. Matemático, Raz. Verbal y Química</strong></p>
              <p>Miércoles, jueves y viernes de 8 a. m. a 1 p. m.</p>
              <p><strong>Talleres: Historietas y English 101</strong></p>
              <p>Martes de 8 a. m. a 12 m.</p>
            </li>


            <li>
              <h2><span class="icon_local_span"><i class="fa fa-stop"></i></span> 4.<sup>o</sup> y 5.<sup>o</sup> año</h2>
              <p><strong>Aritmética, Álgebra, Geometría, Trigonometría, Física, Química, Biología, Raz. Matemático y Raz. Verbal</strong></p>
              <p><strong>Taller de Deporte y Normas APA</strong></p>
              <p>De lunes a viernes de 8 a. m. a 1:30 p. m.</p>
            </li>


            <li>
              <strong><span class="orange">INVERSIÓN: S/370</span></strong> <br>
              <span>(pago por ciclo completo) <br> Incluye material didáctico</span>
            </li>
    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <h3><strong>NORMAS APA</strong></h3>
              <p>
                Con este taller brindamos asesoría a los
                alumnos en sus primeros pasos hacia
                la investigación académica, cuidando
                los detalles en el registro apropiado de
                citas y referencias bibliográficas,
                herramientas indispensables para su
                futuro académico.
              </p>
            </li>
            <br>
            ...
            <li>
              <h3><strong>ENGLISH 101</strong></h3>
              <p>
                Este taller retoma la propuesta del
                verano 2018 e integra el desarrollo
                de la comprensión lectora con las
                habilidades matemáticas y
                científicas de los estudiantes.
                Por medio de una combinación de
                actividades, se explorarán diversas
                materias en un idioma extranjero.
              </p>
            </li>
            <br><br><br>

            <li>
              <h4><strong>ASESORÍAS INCLUIDAS</strong></h4>
              <p>
                Para 4.<sup>o</sup> y 5.<sup>o</sup> año de secundaria contamos
                con un programa de asesorías para los
                siguientes cursos: Aritmética, Álgebra,
