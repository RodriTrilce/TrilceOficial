    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <h3><strong>JUEGOS DE ATENCIÓN Y CONCENTRACIÓN</strong></h3>
              <p>Martes y jueves de 8:30 a. m. a 10 a. m.</p>
            </li>
            ...
            <li>
              ...
              <p>Martes y jueves de 10 a. m. a 11:30 a. m.</p>
            </li>
    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <h3><strong>GUITARRA Y CAJÓN</strong></h3>
              <p>(de 11 a 15 años)</p>
              <p>Miércoles y viernes de 8:30 a. m. a 10 a. m.</p>
            </li>

            <li><br>
              <strong><span class="orange">INVERSIÓN: S/150</span></strong> <br>
              <span>(pago por ciclo completo) <br> No incluye uniforme</span>
            </li>
