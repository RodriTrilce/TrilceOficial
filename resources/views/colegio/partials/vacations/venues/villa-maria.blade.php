    ...
    <ul class="js-tabs__header">
      ...
      <li>
        <a href="#" class="js-tabs__title">
          ...
          <div><span class="vacations-svg__title">Talleres recreativos secundaria</span></div>
        </a>
      </li>
    </ul>
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              ...
              <ul class="ep-generic-list">
                <li>
                  <span class="orange">· Al contado: S/310</span><br>
                  <span class="orange">· 2 partes: S/330</span><br>
        ...
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
                ...
                <br />
                <p>Lunes, martes y jueves de 7:50 a. m. a 1:10 p. m.</p>
            </li>

            <li>
                <h2>4.<sup>o</sup> PRE</h2>
                <p><strong>Aritmética, Álgebra, Geometría, Trigonometría, Raz. Matemático, Raz. Verbal, Física y Química</strong></p>
                <p>De lunes a jueves de 7:50 a. m. a 1:10 p. m.</p>
            </li>
            ...
            <li>
              ...
              <ul class="ep-generic-list">
                ...
                <li>
                  <h4><strong><span class="icon_local_span"><i class="fa fa-stop"></i></span> 4.<sup>o</sup> PRE</strong></h4>
                  <span class="orange">· Al contado: S/360</span><br>
                  <span class="orange">· 2 partes: S/380</span><br>
                  · S/210 (al matricularse)<br>
                  · S/170 (26 de enero)
                </li>
              </ul>
        ...
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              ...
              <p>Miércoles y viernes de 8 a. m. a 9:30 a. m.</p>
            </li>

            <li>
              <h3>Nivel II (2.<sup>o</sup> año)</h3>
              <p>Miércoles y viernes de 9:45 a. m. a 11:15 p. m.</p>
            </li>

            <li>
              <h3>Nivel III (3.<sup>er</sup> año)</h3>
              <p>Miércoles y viernes de 11:30 a. m. a 1 p. m.</p>
            </li>
      ...
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          <ul class="ep-generic-list ep-generic-list--off">
            ...
            <li>
              <p>Lunes a jueves de 7:50 a. m. a 1:10 p. m.</p>
            </li>
            ...
            <li>
              <strong><span class="orange">SISTEMA 5.<sup>o</sup> PRE</span></strong> <br>
            ...
            <li>
              ...
              <span class="orange">
                <strong>
                <i class="fa fa-stop"></i> Al contado: S/360 <br>
                <i class="fa fa-stop"></i> 2 partes: S/380 <br>
                </strong>
                <br>
                S/210 (al matricularse) <br>
                S/170 (26 de enero)
    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <h3><strong>AJEDREZ</strong></h3>
              <p>Martes y jueves de 11:15 a. m. a 12:45 p. m.</p>
            </li>

            <br>

            <li>
              <h3><strong>DIBUJO Y PINTURA</strong></h3>
            ...
            <li>
              <h3><strong>JUEGOS DE ATENCIÓN, CONCENTRACIÓN Y MEMORIA</strong></h3>
              <p>Martes y jueves de 9 a. m. a 10:30 a.m.</p>
            </li>
            ...
            <li>
              <h3><strong>ROBÓTICA LEGO</strong></h3>
              <p>De 6 a 8 años</p>
              <p>Martes y jueves de 9 a. m. a 10:30 a. m.</p>
              <p>De 9 a 11 años</p>
              <p>Martes y jueves de 10:45 a. m. a 12:15 p. m.</p>
    ...
    <div class="js-tabs__content">
      <div class="row col-xs-12">
        <div class="col-sm-6 col-xs-12">
          ...
          <ul class="ep-generic-list ep-generic-list--off">
            <li>
              <h3><strong>DIBUJO ANIME</strong></h3>
              <p>Miércoles y viernes de 10 a. m. a 12 m.</p>
            </li>
            ...
            <li>
              <h3><strong>TEATRO CLOWN</strong></h3>
              <p>Miércoles y viernes de 10 a. m. a 12 m.</p>
            </li>

            <li>
              <h3><strong>DANZA FOLCLÓRICA</strong></h3>
              <p>Miércoles y viernes de 9 a. m. a 11 a. m.</p>
            </li>

            <li><br>
              <strong><span class="orange">INVERSIÓN: S/100</span></strong> <br>
              <span>Por cada taller <br> (pago por ciclo completo) <br> No incluye MATERIALES</span>
            </li>
            ...
            <li>
              <h3><strong>ROBÓTICA LEGO</strong></h3>
              <p>De 11 a 15 años</p>
              <p>Miércoles y viernes de 9:45 a. m. a 11:15 a. m.</p>
            </li>
